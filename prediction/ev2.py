...
def map_sensor_to_features(sensor_data, state_size):
    """
    Map the 8 sensor values to the complete feature set required by the model.
    
    Args:
        sensor_data: Array of sensor readings [temperature, humidity, pressure, altitude, accelX, accelY, accelZ, soil_moisture]
    ...
    # Rainfall
    complete_state[1] = DEFAULT_VALUES['rainfall']
